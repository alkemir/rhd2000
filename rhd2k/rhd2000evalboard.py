...
class Rhd2000EvalBoard:
    ...
    rhd2klib.uploadCommandList.argtypes = [
    ...
    rhd2klib.setCableDelay.argtypes = [
        ctypes.c_void_p, ctypes.c_uint, ctypes.c_int]
    rhd2klib.setCableLengthMeters.restype = None
    rhd2klib.setCableLengthMeters.argtypes = [
        ctypes.c_void_p, ctypes.c_uint, ctypes.c_double]
    rhd2klib.setCableLengthFeet.restype = None
    rhd2klib.setCableLengthFeet.argtypes = [
        ctypes.c_void_p, ctypes.c_uint, ctypes.c_double]
    rhd2klib.estimateCableLengthMeters.restype = ctypes.c_double
    rhd2klib.estimateCableLengthMeters.argtypes = [
    ...
    rhd2klib.setTtlOut.argtypes = [
        ctypes.c_void_p, ctypes.POINTER(ctypes.c_int)]
    rhd2klib.getTtlIn.restype = None
    rhd2klib.getTtlIn.argtypes = [
        ctypes.c_void_p, ctypes.POINTER(ctypes.c_int)]
    ...
    rhd2klib.setLedDisplay.argtypes = [
        ctypes.c_void_p, ctypes.POINTER(ctypes.c_int)]
    rhd2klib.enableDac.restype = None
    rhd2klib.enableDac.argtypes = [
        ctypes.c_void_p, ctypes.c_int, ctypes.c_bool]
    ...
    rhd2klib.selectDacDataStream.argtypes = [
        ctypes.c_void_p, ctypes.c_int, ctypes.c_int]
    rhd2klib.selectDacDataChannel.restype = None
    rhd2klib.selectDacDataChannel.argtypes = [
        ctypes.c_void_p, ctypes.c_int, ctypes.c_int]
    rhd2klib.enableExternalFastSettle.restype = None
    rhd2klib.enableExternalFastSettle.argtypes = [
        ctypes.c_void_p, ctypes.c_bool]
    rhd2klib.setExternalFastSettleChannel.restype = None
    rhd2klib.setExternalFastSettleChannel.argtypes = [
        ctypes.c_void_p, ctypes.c_int]
    rhd2klib.enableExternalDigOut.restype = None
    rhd2klib.enableExternalDigOut.argtypes = [
        ctypes.c_void_p, ctypes.c_uint, ctypes.c_bool]
    rhd2klib.setExternalDigOutChannel.restype = None
    rhd2klib.setExternalDigOutChannel.argtypes = [
        ctypes.c_void_p, ctypes.c_uint, ctypes.c_int]
    rhd2klib.enableDacHighpassFilter.restype = None
    rhd2klib.enableDacHighpassFilter.argtypes = [
        ctypes.c_void_p, ctypes.c_bool]
    ...
    rhd2klib.setDacThreshold.argtypes = [
    ...
    rhd2klib.readDataBlocks.argtypes = [
        ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p]
    rhd2klib.queueToFile.restype = ctypes.c_int
    rhd2klib.queueToFile.argtypes = [
    ...
    def selectAuxCommandLength(self, auxCommandSlot, loopIndex, endIndex):
        rhd2klib.selectAuxCommandLength(
            self, auxCommandSlot, loopIndex, endIndex)
